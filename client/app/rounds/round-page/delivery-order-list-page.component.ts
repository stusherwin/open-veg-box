...
@Component({
  selector: 'cc-delivery-order-list-page',
  templateUrl: 'app/rounds/round-page/delivery-order-list-page.component.html',
  styleUrls: ['app/rounds/round-page/delivery-order-list-page.component.css'],
  pipes: [MoneyPipe],
  directives: [ProductQuantityComponent]
})
export class DeliveryOrderListPageComponent implements OnInit {
  ...
  ngOnInit() {
      this.roundService.getDeliveryOrderList(this.roundPage.round.id, this.page.delivery.id)
