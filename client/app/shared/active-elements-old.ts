...
export interface ActiveElement {
  ...
  correspondingParent: ActiveParentElement
  makeActive(): void
  makeInactive(): void
}
...
export interface ActiveParentElement {
  ...
  handleChildActive(child: ActiveElement): void
  makeInactive(): void  
}
...
export class ActiveParentDirective implements OnInit, OnDestroy, AfterViewInit, ActiveParentElement {
  private active: boolean
  isActiveElement: boolean
  activeElement: ActiveElement
  children: ActiveElement[] = []
  currentActiveChild: ActiveElement = null
  ...
  handleChildActive(child: ActiveElement) {
    console.log('parent.handleChildActive()')
    console.log(this.element)
    let current = this.currentActiveChild;
    this.currentActiveChild = child;
    if(!this.active) {
      this.active = true;
  ...
  makeInactive() {
    console.log('parent.makeInactive()')
    console.log(this.element)
...
export class ActiveDirective implements OnInit, OnDestroy, ActiveElement {
  ...
  makeInactive() {
    console.log('child.makeInactive()')
    console.log(this.element)
    ...
    if(this.active) {
      ...
      // }
      this.deactivate.emit(null);
      if(this.correspondingParent) {
        this.correspondingParent.makeInactive();
      }
    }
  }
}
...
export class ActiveService {
  ...
  registerParent(parent: ActiveParentElement) {
    ...
    if(parent.isActiveElement) {
      ...
      if(childToLink) {
        ...
        childToLink.correspondingParent = parent;
      }
    }
  }
  ...
  registerChild(child: ActiveElement) {
    ...
    if(parentToLink) {
      ...
      child.correspondingParent = parentToLink;
    }
  }
  ...
  deregisterChild(child: ActiveElement) {
    ...
    child.parent = null;
    child.correspondingParent = null;
  }
